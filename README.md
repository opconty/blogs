...
id="toc-stable-diffusion笔记及使用示例">Stable Diffusion笔记及使用示例</a></li>
<li><a href="#ltx-23-vs-wan22-vs-longcat三大开源视频生成模型实测对比"
...
<li><a href="#视频生成模型ltx最佳实践为什么你的ai视频没有电影感" id="toc-视频生成模型ltx最佳实践为什么你的ai视频没有电影感">视频生成模型LTX最佳实践：为什么你的AI视频没有电影感？</a></li>
<li><a href="#分享一个免费开源的ai配音项目支持中文英文以及方言" id="toc-分享一个免费开源的ai配音项目支持中文英文以及方言">分享一个免费开源的AI配音项目，支持中文、英文以及方言</a></li>
...
<li><a href="#震惊工厂老板ai一眼识破不良品准确率堪比火眼金睛"
id="toc-震惊工厂老板ai一眼识破不良品准确率堪比火眼金睛">震惊工厂老板！AI一眼识破不良品，准确率堪比“火眼金睛”！</a></li>
...
<li><a href="#视频剪辑太慢不是你技术差是你没用这个方法从爆肝到躺剪从痛苦到享受" id="toc-视频剪辑太慢不是你技术差是你没用这个方法从爆肝到躺剪从痛苦到享受">视频剪辑太慢不是你技术差，是你没用这个方法！从爆肝到躺剪！从痛苦到享受！</a></li>
<li><a href="#当ai比人更懂你我们还会需要彼此吗" id="toc-当ai比人更懂你我们还会需要彼此吗">当AI比人更懂你，我们还会需要彼此吗？——《道德经》解读</a></li>
<li><a href="#人工智能与信任悖论为什么我们宁愿相信ai却不相信人类" id="toc-人工智能与信任悖论为什么我们宁愿相信ai却不相信人类">人工智能与信任悖论：为什么我们宁愿相信AI却不相信人类？</a></li>
<li><a href="#ai-会拍电影了吗一篇最新综述告诉你答案" id="toc-ai-会拍电影了吗一篇最新综述告诉你答案">AI 会拍电影了吗？一篇最新综述告诉你答案</a></li>
<li><a href="#ffmpeg音视频处理常用命令备忘" id="toc-ffmpeg音视频处理常用命令备忘">ffmpeg音视频处理常用命令备忘</a></li>
<li><a href="#人类反复做同一件事制造泡沫然后亲手戳破它" id="toc-人类反复做同一件事制造泡沫然后亲手戳破它">人类反复做同一件事：制造泡沫，然后亲手戳破它</a></li>
...
### 通过一个简单例子深入浅出理解Agent2Agent协议
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/LyHpv7-z9UfBVQrIImF5Vg)
...
### 空间可控的文生图模型：UniControl、Uni-ControlNet
...
### LTX-2.3 vs Wan2.2 vs Longcat：三大开源视频生成模型实测对比
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/2PY274AkJ_gyJA5rGpOTxg)

> LTX、Wan、Longcat，一个比一个看起来“更强”，Demo 也都很惊艳，但如果你真要落地用（比如做内容、做产品、甚至接入 pipeline），一个很现实的问题是：到底该选哪个？
光看官方demo基本没用，因为都是精挑细选的结果（cherry picking）；参数和 prompt全都不透明；真实效果往往比展示的例子差很多。所以我干脆自己做了一轮实测：用同一批 prompt（八个场景，八条prompt，从简单到复杂，从基础到进阶），同一套参数逻辑，跑了这三个模型，然后从画质、运动表现、稳定性、显存、工程体验等几个维度做了一次完整对比。
...
### 分享一个免费开源的AI配音项目，支持中文、英文以及方言
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/5LSQ9P5ZTaixdG1PvcXnbw)

> 这几年，AI生成图片越来越强，AI视频也开始疯狂进化（比如之前分享的视频生成系列模型），但是很多人忽略了一件事，真正决定像不像真人的，其实是声音，一个视频，哪怕画面一般，只要配音自然、有情绪、有停顿，观感就会瞬间提升；反过来，如果声音像“客服机器人”，再高级的视频也会瞬间掉价。
> 过去我其实试过很多TTS（文本转语音）方案，比如 IndexTTS、EdgeTTS、Bark、XTTS、GPT-SoVITS、Fish Speech、ChatTTS，它们各有优点，但总会存在一些问题：有的中文味太重；有的情绪表达不自然；有的漏音（字儿不发音，吞音），有的部署复杂；有的推理太慢；还有的虽然能克隆声音，但一开口就机器感十足。
...
### 通过代码了解加速pytorch训练的方法（二）：自动混合精度AMP
...
### 震惊工厂老板！AI一眼识破不良品，准确率堪比“火眼金睛”！
[:video_camera:原文 blog post](https://mp.weixin.qq.com/s/jNMoxhzonNxzQvzYS_MQXw)

> 用深度学习模型代替人工检测？这不是实验室演示，这是已经投入流水线实战的工业级不良品检测系统！🚀本视频展示的是AI视觉检测方案，基于深度学习算法，能实时识别不良品并联动报警。准确率高达99.9999%，使用C++进行优化加速，检测速度远超人工，工厂老板都看傻了！👀
想知道AI在工业上到底有多牛？戳视频看实际效果，欢迎评论区交流技术细节或合作可能！🤝
相比之前版本[深度学习算法在工业上的落地应用之不良品检测](https://mp.weixin.qq.com/s/TU4OjJMvFPqISV-lnR55aw)，现在UI更加精美，检测速度更快，功能更加完善。
...
### 视频剪辑太慢不是你技术差，是你没用这个方法！从爆肝到躺剪！从痛苦到享受！
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/V6KlPIbaLhUu7K9T1u4pZw)

> 喜欢剪辑视频的朋友都知道，在剪辑软件中找到自己喜欢和心动的片段真的好难，一秒一秒的观看太浪费时间，拖动时间轴又一不小心就错过了，如果视频有好几个小时那种，非常的费时费力、劳心伤神。
> 那有没有更好的方法呢？既能够快速定位需要的片段，又能够精准地裁剪需要的内容？
有啊！！本文就来分享一个提升视频剪辑效率的方法和流程，让我们从繁重的视频剪辑中解放出来。我用这个方法剪视频，连熬夜都不需要了！还十分享受呢！
> 整个流程分为四个步骤：无声片段检测及移除--》生成字幕 --》挑选字幕片段--》自动裁剪需要的视频片段并组合完整视频。

### 当AI比人更懂你，我们还会需要彼此吗？
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/w-PrAseK4T60BgqXBFReKA)

> 当AI比人更懂你，我们还会需要彼此吗？本文摘自 Eugenia Kuyda 的TED 演讲 Can AI Companions Help Heal Loneliness？
> 这是一场由AI伴侣行业亲历者发出的惊人警告——我们可能正在用技术，悄悄断绝人与人之间的联结。本视频结合《道德经》中关于技术批判、欲望警示、自然法则的智慧，将AI伦理困境提升至文明存续维度，用东方智慧解构技术迷思。我们正在走向一个“AI伴侣比人类更懂你”的世界。这意味着什么？更幸福，还是更孤独？这段演讲出自AI伴侣行业的亲历者——他看清了技术的温柔杀意，也提出了唯一的出路。当我们用技术解决孤独的那一刻，我们可能已经失去了彼此。

### 人工智能与信任悖论：为什么我们宁愿相信AI却不相信人类？
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/0uugNuEZo6_AsOI0Ih3oZA)

> - 最近看了尤瓦尔·赫拉利关于AI与信任悖论的演讲视频，所以尝试着用AI来进行视频理解，提取关键要点、视频总结、章节总结（定位视频时间轴）、以及视频问答和观后感等等。
> - AlphaGo的“神之一手”为何颠覆千年围棋？AI不是工具，是有自主意识的“外星智能”？ 尤瓦尔·赫拉利直击核心：人类能统治世界，靠的不是聪明，是信任陌生人的能力。
现在，AI竞赛正在撕裂这份信任——我们该拥抱还是警惕？答案藏在文明的基因里。
著名历史学家尤瓦尔·诺亚·赫拉利（Yuval Noah Harari）在演讲中深刻剖析了人工智能（AI）的本质、其核心风险以及人类在AI时代的生存之道。核心观点围绕一个深刻的“信任悖论”展开。
> - Yuval Noah Harari（尤瓦尔·诺亚·赫拉利）在演讲中围绕“什么是AI”“AI的危险”“人类如何在AI时代繁荣”三个核心问题展开：明确AI的本质是“能动性”，具备自主学习和创新能力，而非自动化工具；强调AI的“外星性”使其不可预测，可能带来超越人类认知的风险，且存在“信任悖论”——人类对同类信任不足却轻信AI；提出解决方案：人类需放弃内斗，强化彼此信任与合作。因为人类的优势在于大规模协作能力，只有团结才能控制AI，而非被AI支配。最终强调，在AI时代，信任人类自身比信任AI更重要。

### AI 会拍电影了吗？一篇最新综述告诉你答案
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/pS5lnBwI1EuTb6yAli6JsQ)

> 假如你有个电影梦，却没有资金、没有演员、没有摄影机，会怎样？过去这几乎是不可能的事，但现在，AI 不光能写文章、画插画，如今它还悄悄伸手进了“第七艺术”：电影。编剧、分镜、特效、配乐、后期...。几乎每一个环节都能见到 AI 的影子，AI也许能让你“独立完成”一部短片。
> 最近MIT 的研究团队写了一篇综述论文，盘点了生成式 AI（GenAI） 在电影中的最新进展，把生成式 AI 在电影里的最新进展做了个全面梳理：从剧本创作到后期处理，AI几乎都能插上一脚。论文以 MIT AI Film Hack（一个短片创作活动）作为核心案例，分析了创作者在真实电影制作里如何用 GenAI 工具。本文就带你轻松了解：AI到底是如何参与电影创作的，它的优势和短板又在哪。

### ffmpeg音视频处理常用命令备忘
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/p11FAkNiqkpy3WLWtKuIRA)

> 本文记录一下平时常用的使用ffmpeg处理音视频的命令，无论是Windows系统还是Linux都是差不多的。比如视频压缩和视频格式转换、视频中提取音频、多个视频合并、音频合并、视频+字幕/音频合并等等。

### 人类反复做同一件事：制造泡沫，然后亲手戳破它
[:page_facing_up:原文 blog post](https://mp.weixin.qq.com/s/9UzWFGUmTsyKEWwsyy_jPw)
